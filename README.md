  <div style="max-width: 800px; width: 100%; background: #fff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
        <h1 style="text-align: center; color: #1877f2;">Facebook Home with TailwindCSS</h1>
        <p style="line-height: 1.6;">
            In this project, I recreated the Facebook login page using HTML and TailwindCSS. The idea was to reproduce the basic design of the Facebook login page, focusing on creating a clean and functional interface.
        </p>
        <h2 style="color: #555;">HTML:</h2>
        <p style="line-height: 1.6;">
            I used HTML to structure the page. This included creating the input fields for email and password, the login and account creation buttons, as well as the links for password recovery and other features. The structure was organized to reflect the typical arrangement of elements on the actual login page.
        </p>
